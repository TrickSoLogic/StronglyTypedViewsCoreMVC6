...
using StronglyTypedViewsCoreMVC6.Models;

namespace StronglyTypedViewsCoreMVC6.Controllers
{
  public class HomeController : Controller
  {
    ...
    public IActionResult Index()
    {
      ...
      {
          new Person() { Name = "Black1", DateOfBirth = DateTime.Parse("2000-05-06"), PersonGender = Gender.Male},
